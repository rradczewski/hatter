...
BASE_IMAGE=ghcr.io/rradczewski/hatter/base/fedora/fedora-silverblue:44-x86_64-now@sha256:a6024ba67a9ee623f09f56c5c81ede5d422564b80fcb04863727ab7bc9164967
...
$(render_snippets "${BASE_DIR}/storm10x/")
