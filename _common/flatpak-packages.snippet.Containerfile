...
RUN \
    ...
    cat /_common/flatpak-packages/packages.fedora.list | xargs -I '{}' ln -s /etc/systemd/system/flatpak-install-fedora@{}.service /etc/systemd/system/multi-user.target.wants/flatpak-install-flathub@{}.service
...
RUN \
    ...
    cat /_common/flatpak-packages/packages.flathub.list | xargs -I '{}' ln -s /etc/systemd/system/flatpak-install-flathub@{}.service /etc/systemd/system/multi-user.target.wants/flatpak-install-flathub@{}.service
